...
public:
	...
	*/
	...
	/** Pointer to an optional shared narrative component. */
	UPROPERTY(Replicated, BlueprintReadOnly, Category = "Narrative")
	class UNarrativeComponent* SharedNarrativeComp;

	/** All of the players sharing this component. Server tracks this so doesn't require replication */
	UPROPERTY(BlueprintReadOnly, Category = "Narrative")
	TArray<class UNarrativeComponent*> GroupMembers;
...
public:
	...
	* 
	...
	virtual bool HasDialogueAvailable(TSubclassOf<class UDialogue> Dialogue, class AActor* DefaultAvatar, FName StartFromID = NAME_None);
	...
	*/
	...
	/**Used by the server to tell client to start dialogue. Also sends the initial chunk*/
	UFUNCTION(Client, Reliable, Category = "Dialogues")
	virtual void ClientBeginSharedDialogue(TSubclassOf<class UDialogue> Dialogue, class AActor* NPC, const TArray<FName>& NPCReplyChainIDs, const TArray<FName>& AvailableResponseIDs);
	...
	/**Allows the server to inform a client to select a dialogue option. Used by shared dialogues */
	UFUNCTION(Client, Reliable, Category = "Dialogues")
	virtual void ClientSelectDialogueOption(const FName& OptionID, class APawn* Selector/*=nullptr*/);
	...
	/**Tell the server to select one of its shared options*/
	UFUNCTION(Server, Reliable, Category = "Dialogues")
	virtual void ServerSelectSharedDialogueOption(const FName& OptionID);
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "Shared Quests")
