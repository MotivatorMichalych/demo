...
protected:
	...
	*/
	...
	//In shared dialogue, we sometimes need override the playeravatar to the other player that is speaking. To do that, we set this variable 
	UPROPERTY(BlueprintReadOnly, Category = "Dialogue")
	APawn* SharedDialoguePlayerAvatar;
...
public:
	...
	void SetSharedDialoguePlayerAvatar(class APawn* PawnOverride);
