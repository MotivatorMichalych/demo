...
#include "AnimGraphNode_NarrativeDialogue.generated.h"

class UEdGraph;

UCLASS(MinimalAPI, meta=(Keywords = "Narrative Dialogue Head"))
class UAnimGraphNode_NarrativeDialogue : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_NarrativeDialogue Node;
